...
//!
//! ``` rust
//! use patina_sdk::component::params::{Config, ConfigMut};
//!
...
//!
//! ``` rust
//! # use patina_sdk::{error::Result, component::params::{ConfigMut, Config}};
...
impl<T: Default + 'static> Config<'_, T> {
    ...
    /// ## Example
    /// ``` rust
    /// use patina_sdk::component::params::Config;
    ///
...
impl<T: Default + 'static> ConfigMut<'_, T> {
    ...
    /// ## Example
    /// ``` rust
    /// use patina_sdk::component::params::ConfigMut;
    ///
