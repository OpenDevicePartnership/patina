...
/// ```
/// # use patina_sdk::{Guid, guids::DXE_CORE};
...
/// ```
/// # use patina_sdk::{Guid, guids::EBS_FAILED};
...
/// ```
/// # use patina_sdk::{Guid, guids::EDKII_FPDT_EXTENDED_FIRMWARE_PERFORMANCE};
...
/// ```
/// # use patina_sdk::{Guid, guids::EVENT_GROUP_END_OF_DXE};
...
/// ```
/// # use patina_sdk::{Guid, guids::HARDWARE_INTERRUPT_PROTOCOL};
...
/// ```
/// # use patina_sdk::{Guid, guids::HARDWARE_INTERRUPT_PROTOCOL_V2};
...
/// ```
/// # use patina_sdk::{Guid, guids::MEMORY_TYPE_INFORMATION};
...
/// ```
/// # use patina_sdk::{Guid, guids::PERFORMANCE_PROTOCOL};
...
/// ```
/// # use patina_sdk::{Guid, guids::SMM_COMMUNICATION_PROTOCOL};
...
/// ```
/// # use patina_sdk::{Guid, guids::ZERO};
...
/// ```
pub const HOB_MEMORY_ALLOC_STACK: efi::Guid = efi::Guid::from_fields(0x4ed4bf27, 0x4092, 0x42e9, 0x80, 0x7d, &[0x52, 0x7b, 0x1d, 0x00, 0xc9, 0xbd]);
