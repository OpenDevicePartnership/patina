...
pub fn core_load_image(
    ...
    perf_load_image_begin(core::ptr::null_mut(), create_performance_measurement_internal);
    ...
    perf_load_image_end(handle, create_performance_measurement_internal);
...
pub fn core_start_image(image_handle: efi::Handle) -> Result<(), efi::Status> {
    ...
    perf_image_start_begin(image_handle, create_performance_measurement_internal);
    ...
    perf_image_start_end(image_handle, create_performance_measurement_internal);
