...
- 2025-04-27: Add details on installing EDK II protocols from Rust.
...
will also produce C protocols to support the existing EDK II `EFI_ACPI_TABLE_PROTOCOL` and `EFI_ACPI_SDT_PROTOCOL`.
