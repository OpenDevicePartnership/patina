...
fn core_connect_single_controller(
    ...
    loop {
        ...
        for driver_binding_interface in driver_candidates.clone() {
            ...
            perf_driver_binding_support_begin(driver_binding.driver_binding_handle, controller_handle, uefi_performance::create_performance_measurement);
            ...
            match (driver_binding.supported)(driver_binding_interface, controller_handle, device_path) {
                efi::Status::SUCCESS => {
                    perf_driver_binding_support_end(driver_binding.driver_binding_handle, controller_handle, uefi_performance::create_performance_measurement);

                    started_drivers.push(driver_binding_interface);

                    perf_driver_binding_start_begin(driver_binding.driver_binding_handle, controller_handle, uefi_performance::create_performance_measurement);
                    ...
                    perf_driver_binding_start_end(driver_binding.driver_binding_handle, controller_handle, uefi_performance::create_performance_measurement);
                }
                _ => {
                    perf_driver_binding_support_end(driver_binding.driver_binding_handle, controller_handle, uefi_performance::create_performance_measurement);
                    continue;
