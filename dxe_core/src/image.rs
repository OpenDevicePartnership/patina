...
pub fn core_load_image(
    ...
    _ = perf_load_image_begin(core::ptr::null_mut(), uefi_performance::create_performance_measurement);
...
pub fn core_start_image(image_handle: efi::Handle) -> Result<(), efi::Status> {
    ...
    _ = perf_image_start_begin(image_handle, uefi_performance::create_performance_measurement);
    ...
    _ = perf_image_start_end(image_handle, uefi_performance::create_performance_measurement);
