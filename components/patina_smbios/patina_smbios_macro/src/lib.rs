//! Procedural macros for SMBIOS record structures
//!
//! This crate provides derive macros for implementing SMBIOS records in a safe and ergonomic way.
    ...
    for attr in attrs {
            ...
            && let Meta::List(meta_list) = &attr.meta
        {
            ...
            if let Ok(name_value) = parsed
                && name_value.path.is_ident("record_type")
