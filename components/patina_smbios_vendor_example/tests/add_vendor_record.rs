use patina_smbios::smbios_derive::SmbiosTableHeader;
use patina_smbios::smbios_derive::{SMBIOS_HANDLE_PI_RESERVED, SmbiosManager, SmbiosRecords};
use patina_smbios::smbios_record::{FieldInfo, FieldLayout, FieldType};
use patina_smbios::smbios_record::{SmbiosFieldLayout, SmbiosRecordStructure};
...
#[test]
fn adds_vendor_record_to_manager() {
